# Minimal Python REST example

This is the one-file Python example for `odds-api/odds-api`.
...
Use this example when you want a one-file Python odds API integration.

For typed Python SDK usage, OpenAPI, mock mode, MCP tools, arbitrage, positive EV, bookmaker comparison, and line movement, use the [main README](../../../README.md) and [`openapi.yaml`](../../../openapi.yaml).
